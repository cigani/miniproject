...
#    plt.plot(hex.t/b2.ms, hex.KIslow[0]/b2.uamp/1000,lw=2,label='Kslow')
    ...
    plt.subplot(311)
    plt.plot(hex.vm[0]/b2.mV, hex.n[0] /nrmfactor /b2.mV, 'red', lw=2)
    plt.ylabel('A.U')
    plt.legend('ninf')
    plt.subplot(312)
    plt.plot(hex.vm[0]/b2.mV, hex.m[0] /nrmfactor /b2.mV, 'black', lw=2)
    plt.ylabel('A.U')
    plt.legend('minf')
    plt.subplot(313)
    plt.plot(hex.vm[0]/b2.mV, hex.h[0] /nrmfactor /b2.mV, 'blue', lw=2)
    plt.ylabel('A.U')
    plt.legend('hinf')
    plt.xlabel('v [mV]')
